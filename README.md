-----
# Yama's build of dwmblocks

This is essentially the Luke Smith build. I have not really changed much.
Scripts to display the information on the bar can be found on my dotfiles repo.
